...
# gets the full knot hash from a bytes or bytearray object
# returns knot hash (bytearray)
def getKnotHash(bytesToHash):
	inputBytes = bytearray(bytesToHash)
...
if __name__ == "__main__":
	...
	knotHash = getKnotHash(inputBytes)
	hashString = binascii.hexlify(knotHash).decode("ascii")
	print("Part 2 - Dense Hash: " + hashString)